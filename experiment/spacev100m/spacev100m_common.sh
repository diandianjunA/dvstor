...
PERFORMANCE_QUERY_FILE="${PERFORMANCE_QUERY_FILE:-$DATASET_DIR/spacev100m_to_110m_query.i8bin}"
PERFORMANCE_QUERY_START="${PERFORMANCE_QUERY_START:-100000000}"
PERFORMANCE_QUERY_END="${PERFORMANCE_QUERY_END:-110000000}"
INSERT_FILE="${INSERT_FILE:-$DATASET_DIR/spacev110m_to_120m_insert.i8bin}"
