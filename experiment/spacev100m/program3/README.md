...
```bash
cd /home/xjs/experiment/dvstor
GPU_COMMIT_WIDTH=4 ./experiment/spacev100m/program3/start_storage_case.sh early
```
...
```bash
RUN_ROOT=/path/to/program3_TIMESTAMP ./experiment/spacev100m/program3/run_program3.sh motivation
RUN_ROOT=/path/to/program3_TIMESTAMP ./experiment/spacev100m/program3/run_program3.sh performance
RUN_ROOT=/path/to/program3_TIMESTAMP ./experiment/spacev100m/program3/run_program3.sh summarize
```
