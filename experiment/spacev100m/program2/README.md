...
```bash
./experiment/spacev100m/program2/start_storage_case.sh fixed
./experiment/spacev100m/program2/start_storage_case.sh header
...
```bash
RUN_ROOT=/path/to/program2_TIMESTAMP ./experiment/spacev100m/program2/run_program2.sh live
RUN_ROOT=/path/to/program2_TIMESTAMP ./experiment/spacev100m/program2/run_program2.sh summarize
```

可选协议 probe（不是主实验必需）：

```bash
RUN_ROOT=/path/to/program2_TIMESTAMP ./experiment/spacev100m/program2/run_program2.sh probe
```
