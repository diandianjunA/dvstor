...
def main() -> None:
    ...
    parser.add_argument("--query-end", type=int, default=110_000_000)
    parser.add_argument("--insert-output", required=True)
    parser.add_argument("--insert-start", type=int, default=110_000_000)
    parser.add_argument("--insert-end", type=int, default=120_000_000)
