...
lines = [
    ...
    "## 1. 实验设置与问题",
    "",
    "测试使用 DEEP100M、Beam=128、Persistent GPU + GPUNetIO、Stable-Run 和 Live/DynaExtent。动机实验保持其他配置不变，只扫描每轮权威扩展批量 C=1/4/8/16；每点预热 5 s、测量 10 s。效果实验固定 C=16，只切换 Late-Issue 与 Exact-Early-Issue，每组预热 5 s、测量 20 s，均只运行一次。",
    "",
