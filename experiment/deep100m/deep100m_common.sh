...
DATASET_DIR="${DATASET_DIR:-/data/xjs/datasets/deep1b/deep100m}"
WORK_DIR="${WORK_DIR:-/data/xjs/index/dvstor_deep100m}"
...
K="${K:-10}"
DIM="${DIM:-96}"
VECTOR_DATA_TYPE="${VECTOR_DATA_TYPE:-float32}"
...
INDEX_PREFIX="${INDEX_PREFIX:-$INDEX_DIR/deep100m_R${R}_bw${BUILD_BEAM}_${PARTITION_STRATEGY}_pq${PQ_SUBQUANTIZERS}}"
...
query_bin() { echo "$CONVERTED_DIR/recall_query.fbin"; }
