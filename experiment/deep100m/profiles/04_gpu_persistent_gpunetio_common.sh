...
# full DEEP100M systems.  The two .env files may differ only in their variant
...
INDEX_PREFIX="${PQ_INDEX_PREFIX:-$INDEX_DIR/deep100m_R${R}_bw${BUILD_BEAM}_${PARTITION_STRATEGY}_pmd${PARTITION_MAX_DEGREE}_pq${PQ_SUBQUANTIZERS}_schema16}"
