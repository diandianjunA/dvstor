...
struct MaintenanceLogSummary {
  ...
  uint64_t active_stage2_contexts_latest_sum{};
  uint64_t active_stage2_context_limit_sum{};
  uint64_t active_stage2_context_limit_baseline_sum{};
  uint64_t active_stage2_context_limit_max_sum{};
  uint64_t active_stage2_task_limit_baseline_sum{};
  uint64_t active_stage2_task_limit_max_sum{};
  uint64_t stage2_budget_promotions{};
  uint64_t stage2_budget_rollbacks{};
  uint64_t stage2_budget_lane_rollbacks{};
  uint64_t stage2_budget_low_backlog_rollbacks{};
  uint64_t stage2_budget_rate_rollbacks{};
  uint64_t stage2_budget_rate_trials_accepted{};
  uint64_t stage2_budget_high_backlog_samples{};
  uint64_t stage2_budget_lane_headroom_samples{};
  uint64_t stage2_budget_stable_rate_milli_per_sec_sum{};
  uint64_t stage2_budget_trial_baseline_rate_milli_per_sec_sum{};
  uint64_t stage2_budget_rate_trial_pending_sum{};
  uint64_t stage2_budget_promotion_context_limit_sum{};
  uint64_t maintenance_periodic_fallback_audits{};
  uint64_t maintenance_periodic_fallback_recoveries{};
  uint64_t stage2_finalized_live{};
  uint64_t stage2_continuations{};
  uint64_t stage2_remote_frontier_items{};
  uint64_t stage2_remote_expansions{};
  ...
  size_t logs_with_execution_budget_deltas{};
  size_t logs_with_fallback_audit_deltas{};
  ...
  bool active_stage2_task_gauge_available{};
  bool execution_budget_delta_available{};
  bool fallback_audit_delta_available{};
