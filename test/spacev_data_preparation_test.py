...
MODULE_PATH = (
    PROJECT_DIR / "experiment" / "spacev100m" / "prepare_spacev100m_data.py"
)


def load_preparation_module():
    spec = importlib.util.spec_from_file_location("spacev_data_preparation", MODULE_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"cannot load SPACEV preparation module: {MODULE_PATH}")
