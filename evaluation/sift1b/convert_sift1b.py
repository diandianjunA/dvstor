...
try:
    ...
    raise SystemExit("convert_sift1b.py requires numpy for practical SIFT1B conversion") from exc
...
def main():
    parser = argparse.ArgumentParser(description='Convert SIFT1B bvecs/ivecs files to dvstor .u8bin/.bin files.')
    ...
    parser.add_argument('--groundtruth-label', default='1000M')
