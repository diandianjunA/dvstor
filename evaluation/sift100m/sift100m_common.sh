...
NEIGHBOR_CACHE_INVALIDATION_MS="${NEIGHBOR_CACHE_INVALIDATION_MS:-100}"
NEIGHBOR_CACHE_INVALIDATION_INSERTS="${NEIGHBOR_CACHE_INVALIDATION_INSERTS:-1024}"
GPU_RABITQ_CACHE_MB="${GPU_RABITQ_CACHE_MB:-8192}"
RABITQ_CACHE_MODE="${RABITQ_CACHE_MODE:-slot_clock}"
GENTILE_TILE_SLOTS="${GENTILE_TILE_SLOTS:-32}"
GENTILE_NURSERY_RATIO="${GENTILE_NURSERY_RATIO:-0.25}"
GENTILE_PROMOTION_THRESHOLD="${GENTILE_PROMOTION_THRESHOLD:-2}"
GENTILE_ENABLE_PROMOTION="${GENTILE_ENABLE_PROMOTION:-false}"
GENTILE_ENABLE_VALUE_BIN="${GENTILE_ENABLE_VALUE_BIN:-false}"
GENTILE_ENABLE_HIT_TILE_GROUPING="${GENTILE_ENABLE_HIT_TILE_GROUPING:-true}"
