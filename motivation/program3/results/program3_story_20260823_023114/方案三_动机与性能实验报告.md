...
|---|---:|---:|
| GPU 距离评分 | 530.0 μs | 12.8% |
| RDMA 等待 | 1154.0 μs | 27.8% |
| Merge | 995.9 μs | 24.0% |
| 其他准备、校验及最终处理 | 1469.3 μs | 35.4% |
| **合计** | **4149.2 μs** | **100%** |

RDMA 与 Merge 合计占 GPU 查询时间的 **51.8%**。这说明查询同时受到网络等待和 Merge 软件屏障影响，为让下一轮 RDMA 与剩余 Merge 重叠提供了直接动机。
