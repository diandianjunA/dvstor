...
- Trace: `/home/xjs/experiment/dvstor/motivation/results/batch_barrier/trace/depth_8/concurrency_256/repeat_1/rdma_trace.jsonl`
- Integrity suitable for a headline result: **yes**
- Traced queries: 212
- Complete primary attempts: 4684
- Multi-shard primary attempts: 1427 (30.5%)

## Observable barrier evidence

| Metric | Result |
|---|---:|
| Completion spread P50 (eligible multi-shard) | 11.26 us |
| Completion spread P90 (eligible multi-shard) | 34.20 us |
| Strict post-issue wait spread P50 | 11.26 us |
| Strict post-issue wait spread P90 | 34.20 us |
| Parent-weighted strict barrier waste | 5.0% |
| Parents observable before tail completion | 14.3% |
| Parents ready >=10 us before tail | 8.3% |
| Query overlap upper bound / RDMA wait P50 | 4.5% |
| Query overlap upper bound / GPU time P50 | 1.0% |
...
```json
{
  ...
  "query_records": 212,
  "shard_batch_events": 6247,
  "round_attempt_groups": 4684,
  "complete_round_attempt_groups": 4684,
