...
- Input: `/home/xjs/experiment/dvstor/motivation/results/batch_barrier/trace/depth_8/concurrency_256/repeat_1/rdma_trace.jsonl`
...
|---|---:|
| Primary rounds | 4684 |
| Rounds with >=2 release boundaries | 29.59% |
| Strict spread P50/P90/P99 | 12.29 / 34.82 / 97.64 us |
| Natural tile ready >=10 us before tail | 7.96% |
...
|---:|---:|---:|---:|
| 0 us | 0.71% | 3.08% | 34.05 us |
| 1 us | 0.51% | 2.19% | 25.34 us |
| 2 us | 0.36% | 1.52% | 17.02 us |
