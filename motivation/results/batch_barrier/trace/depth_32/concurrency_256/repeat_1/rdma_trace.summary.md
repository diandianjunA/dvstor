...
- Trace: `/home/xjs/experiment/dvstor/motivation/results/batch_barrier/trace/depth_32/concurrency_256/repeat_1/rdma_trace.jsonl`
- Integrity suitable for a headline result: **yes**
- Traced queries: 186
- Complete primary attempts: 2088
- Multi-shard primary attempts: 770 (36.9%)

## Observable barrier evidence

| Metric | Result |
|---|---:|
| Completion spread P50 (eligible multi-shard) | 37.38 us |
| Completion spread P90 (eligible multi-shard) | 155.03 us |
| Strict post-issue wait spread P50 | 37.38 us |
| Strict post-issue wait spread P90 | 155.03 us |
| Parent-weighted strict barrier waste | 9.1% |
| Parents observable before tail completion | 15.0% |
| Parents ready >=10 us before tail | 12.3% |
| Query overlap upper bound / RDMA wait P50 | 19.5% |
| Query overlap upper bound / GPU time P50 | 3.6% |
...
```json
{
  ...
  "query_records": 186,
  "shard_batch_events": 3013,
  "round_attempt_groups": 2088,
  "complete_round_attempt_groups": 2088,
