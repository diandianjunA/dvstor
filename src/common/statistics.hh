...
struct ThreadStatistics {
  ...
  size_t rdma_read_ops{0};
  size_t rdma_write_ops{0};
  ...
  size_t query_rdma_read_ops{0};
  size_t build_rdma_read_ops{0};
  size_t query_rdma_write_ops{0};
  size_t build_rdma_write_ops{0};
  ...
  size_t vector_rdma_batch_calls{0};
  size_t vector_rdma_chunks{0};
  size_t vector_rdma_active_nodes{0};
  size_t vector_rdma_active_qps{0};
  size_t vector_rdma_chain_wrs{0};
  size_t vector_rdma_max_chain_wrs{0};
  size_t vector_rdma_qp_high_water_wrs{0};
  size_t vector_rdma_credit_waits{0};
  u64 vector_rdma_credit_wait_ns{0};
  size_t vector_rdma_completion_token_waits{0};
  size_t vector_rdma_post_send_calls{0};
  size_t vector_rdma_post_send_retries{0};
  size_t vector_rdma_post_send_errors{0};
  ...
  size_t query_credit_postcommit_expansions{0};
  size_t query_credit_grow_events{0};
  size_t query_credit_shrink_events{0};
  size_t query_credit_credit_stalls{0};
  size_t query_credit_no_progress_rounds{0};
  size_t query_credit_underfilled_rounds{0};
  size_t query_credit_overfilled_rounds{0};
  size_t query_credit_cost_guard_events{0};
  size_t query_credit_cost_growth_blocked{0};
  size_t query_credit_cost_baseline_samples{0};
  size_t build_l2_kernels{0};
  size_t build_prune_kernels{0};
  size_t build_overflow_prunes{0};
  size_t build_overflow_prune_candidates{0};
  size_t build_overflow_prune_max_candidates{0};
  size_t build_overflow_prune_pair_checks_upper_bound{0};
  size_t build_overflow_prune_global_load_bytes_upper_bound{0};
  size_t build_overflow_prune_kernel_blocks{0};
  size_t build_overflow_prune_kernel_threads{0};
  size_t build_overflow_prune_max_kernel_threads{0};
  size_t processed{0};
