...
inline void add_sample(Aggregate& aggregate, const Sample& sample) {
  ...
  aggregate.counters.gpu_rabitq_cache_nursery_hits += delta.gpu_rabitq_cache_nursery_hits;
  aggregate.counters.gpu_rabitq_cache_hot_hits += delta.gpu_rabitq_cache_hot_hits;
  aggregate.counters.gpu_rabitq_cache_promotions += delta.gpu_rabitq_cache_promotions;
  aggregate.counters.gpu_rabitq_cache_nursery_overwrites += delta.gpu_rabitq_cache_nursery_overwrites;
  aggregate.counters.gpu_rabitq_cache_hot_tile_evictions += delta.gpu_rabitq_cache_hot_tile_evictions;
  aggregate.counters.gpu_rabitq_cache_unique_tiles += delta.gpu_rabitq_cache_unique_tiles;
  aggregate.counters.gpu_rabitq_cache_tile_tasks += delta.gpu_rabitq_cache_tile_tasks;
  aggregate.counters.gpu_rabitq_cache_miss_ranges += delta.gpu_rabitq_cache_miss_ranges;
  aggregate.counters.gpu_rabitq_cache_resolve_ns += delta.gpu_rabitq_cache_resolve_ns;
  aggregate.counters.gpu_rabitq_cache_victim_ns += delta.gpu_rabitq_cache_victim_ns;
  aggregate.counters.gpu_rabitq_cache_kernel_ns += delta.gpu_rabitq_cache_kernel_ns;
  aggregate.counters.gpu_rabitq_cache_rdma_ns += delta.gpu_rabitq_cache_rdma_ns;
