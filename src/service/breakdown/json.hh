...
inline nlohmann::json aggregate_to_json(const Aggregate& aggregate) {
  ...
  out["counters"] = {
    ...
    {"gpu_rabitq_cache_nursery_hits", aggregate.counters.gpu_rabitq_cache_nursery_hits},
    {"gpu_rabitq_cache_hot_hits", aggregate.counters.gpu_rabitq_cache_hot_hits},
    {"gpu_rabitq_cache_promotions", aggregate.counters.gpu_rabitq_cache_promotions},
    {"gpu_rabitq_cache_nursery_overwrites", aggregate.counters.gpu_rabitq_cache_nursery_overwrites},
    {"gpu_rabitq_cache_hot_tile_evictions", aggregate.counters.gpu_rabitq_cache_hot_tile_evictions},
    {"gpu_rabitq_cache_unique_tiles", aggregate.counters.gpu_rabitq_cache_unique_tiles},
    {"gpu_rabitq_cache_tile_tasks", aggregate.counters.gpu_rabitq_cache_tile_tasks},
    {"gpu_rabitq_cache_miss_ranges", aggregate.counters.gpu_rabitq_cache_miss_ranges},
    {"gpu_rabitq_cache_resolve_ns", aggregate.counters.gpu_rabitq_cache_resolve_ns},
    {"gpu_rabitq_cache_victim_ns", aggregate.counters.gpu_rabitq_cache_victim_ns},
    {"gpu_rabitq_cache_kernel_ns", aggregate.counters.gpu_rabitq_cache_kernel_ns},
    {"gpu_rabitq_cache_rdma_ns", aggregate.counters.gpu_rabitq_cache_rdma_ns},
