...
inline nlohmann::json aggregate_to_json(const Aggregate& aggregate) {
  ...
  out["counters"] = {
    ...
    {"gpu_vector_cache_hits", aggregate.counters.gpu_vector_cache_hits},
    {"gpu_vector_cache_misses", aggregate.counters.gpu_vector_cache_misses},
    {"neighbor_cache_lookup_probes", aggregate.counters.neighbor_cache_lookup_probes},
    {"neighbor_cache_insert_probes", aggregate.counters.neighbor_cache_insert_probes},
    {"gpu_vector_cache_lookup_probes", aggregate.counters.gpu_vector_cache_lookup_probes},
    {"gpu_vector_cache_alloc_probes", aggregate.counters.gpu_vector_cache_alloc_probes},
    {"neighbor_cache_admitted", aggregate.counters.neighbor_cache_admitted},
    {"neighbor_cache_rejected", aggregate.counters.neighbor_cache_rejected},
    {"gpu_vector_cache_admitted", aggregate.counters.gpu_vector_cache_admitted},
    {"gpu_vector_cache_rejected", aggregate.counters.gpu_vector_cache_rejected},
